...
public class GameController : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        WarriorController warControllera = Instantiate(warriorPrefab, new Vector3(15.0f, 15.0f, 15.0f), Quaternion.identity).GetComponent<WarriorController>();
        WarriorController warControllerb = Instantiate(warriorPrefab, new Vector3(15.0f, 15.0f, 15.0f), Quaternion.identity).GetComponent<WarriorController>();
        ...
        WarriorController warController2a = Instantiate(warriorPrefab, new Vector3(26.0f, 26.0f, 26.0f), Quaternion.identity).GetComponent<WarriorController>();
        WarriorController warController2b = Instantiate(warriorPrefab, new Vector3(26.0f, 26.0f, 26.0f), Quaternion.identity).GetComponent<WarriorController>();
